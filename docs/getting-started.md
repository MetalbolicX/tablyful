...
> [!Note] On some Linux systems installing global npm packages may require elevated permissions. Prefer using nvm to avoid sudo, or configure npm's global directory per the npm docs.
